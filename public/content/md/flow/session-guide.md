...
- **Think Partner, Not Guru**: You don't need all the answers. Your role is to help them think better, not to tell them what to do.
- **Scout Mindset**: Explore the terrain together. Build hypotheses and look for evidence, rather than defending a position.
- **Embrace Uncertainty**: It's okay to say "I don't know." Pivot the conversation to: *How could we find out?*

## Standard operating flow (60–90 minutes)

### Before the meeting

**Context Gathering**: Ask open-ended questions like "What helps me prepare?" or "What is on your mind?" to allow them to set the agenda without rigid homework.
...
- Don't test the career; test the hypothesis. Start with the lowest friction step that gives valid signal.
    - **Quick Taste (<1 hour)**: Read an article, watch a talk, listen to a podcast. (Test: Is the topic interesting?)
    - **Deeper Dive**: Take a short course, apply for a fellowship, speak to a practitioner. (Test: Do I want to go deeper?)
    - **Hands On**: Join a project, volunteer, run a small trial. (Test: Do I enjoy the actual work/impact?)
