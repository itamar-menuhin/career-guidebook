            ...
            {navItems.map(item => {
              ...
              return (
                <Link
                  ...
                  to={item.path}
                  className={cn(
                    'flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 border border-transparent',
                    isActive
                      ? 'bg-primary/15 text-primary ring-1 ring-primary/30 shadow-xs border-primary/30'
